...
public class AmbientTickHandler {
    ...
    public void onRender(RenderTickEvent event) {
        if (showDebugInfo && event.phase == Phase.END && engine != null && mc.inGameHasFocus && enviroment != null) {
            ...
            details.add("worldRain", enviroment.overallRaining);
            details.add("snow", enviroment.snowing);
            ...
            details.add("height", df.format(enviroment.relativeHeight) + "," + df.format(enviroment.averageHeight) + "," + df.format(enviroment.player.posY - enviroment.minHeight) + "," + df
                .format(enviroment.player.posY - enviroment.maxHeight));
